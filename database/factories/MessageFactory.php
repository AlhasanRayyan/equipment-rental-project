...
class MessageFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        // Optionally associate with a booking (booking_id is nullable)
        ...
        return [
            ...
            'message_type' => $this->faker->randomElement(['text', 'image', 'attachment']),
            'attachment_url' => $this->faker->optional(0.1)->imageUrl(),
