                            ...
                            <div class="dropdown-content" id="dropdownMenu">
                                @if ($user)
                                    ...
                                    {{-- <form action="{{ route('logout') }}" method="POST" style="display:inline;">
                                        @csrf
                                        <button type="submit"
                                            style="all:unset;cursor:pointer;display:flex;align-items:center;gap:8px;">
        ...
        <main class="page-main">
                                ...
                                @php
                                    ...
                                    $user =
                                        ...
                                        (object) [
                                            ...
                                            'description' =>
                                                'لم تقم بتسجيل الدخول بعد. قم بتسجيل الدخول لتخصيص ملفك الشخصي.',
                                        ];
                        ...
                        <div class="text">
                            ...
                            <div class="actions">
                                <a class="btn btn--primary"
                                    href="{{ $user->id ? route('profile.edit', $user->id) : '#' }}"
            ...
            <section class="stats-section">
                <a href="#" class="stat-box"
                    onclick="loadPage('{{ route('profile.section', 'equipments') }}')">
                ...
                <a href="#" class="stat-box"
                    onclick="loadPage('{{ route('profile.section', 'favorites') }}')">
                ...
                function loadPage(url) {
                    fetch(url)
                        ...
                        .then(html => {
                            ...
                            setTimeout(() => content.scrollIntoView({
                                behavior: 'smooth'
                            }), 50);
                        })
                        .catch(() => {
