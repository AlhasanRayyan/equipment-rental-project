...
<body>
    <div class="update-container">
        <div class="photo-section">
            <img src="{{ asset('assets/home/img/img-reviews-3.png')}}" id="userPhoto">
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <input type="text" id="firstName" value="Mohammed" placeholder="الاسم الأول">
            </div>
            <div class="form-group">
                <i class="fas fa-user"></i>
                <input type="text" id="lastName" value="Mohammed" placeholder="الاسم الأخير">
            </div>
            <div class="form-group">
                <i class="fas fa-envelope"></i>
                <input type="email" id="email" value="mohammed@gmail.com" placeholder="البريد الإلكتروني">
            </div>
            <div class="form-group">
                <i class="fas fa-phone"></i>
                <input class="phonInput" value="0597654897" type="tel" id="phone" placeholder="رقم الهاتف">
            </div>
            <div class="form-group">
                <i class="fas fa-map-marker-alt"></i>
                <input type="text" value="غزة" id="address" placeholder="العنوان">
            </div>
            <div class="form-group">
                <i class="fas fa-align-left"></i>
                <textarea id="description" placeholder="الوصف / ملاحظات إضافية"></textarea>
            </div>
