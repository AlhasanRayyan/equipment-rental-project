                    ...
                    <div>
                        <div class="blog-item"> {{-- يمكن تغيير هذا إلى uk-card أو أي تصميم مناسب لعرض المعدة --}}
                            <div class="blog-item__media">
                                ...
                                <div class="blog-item__category">{{ $equipment->category->category_name ?? 'غير مصنف' }}</div>
                            </div>
                            <div class="blog-item__body">
                                ...
                                <div class="rating">
                                    @for ($i = 1; $i <= 5; $i++)
                                        <span class="uk-icon" data-uk-icon="icon: star{{ $equipment->average_rating >= $i ? '' : '-o' }}; ratio: 0.8"></span>
                                    @endfor
                            ...
                            <div class="blog-item__bottom">
                                <a class="link-more" href="{{ route('equipments.show', $equipment->id) }}">
                                    <span>إقرأ أكثر</span>
                                    <img class="ukos" src="{{ asset('assets/home/img/icons/arrow.svg') }}" alt="arrow"
                                        data-uk-svg>
                                </a>
                            </div>
                        </div>
