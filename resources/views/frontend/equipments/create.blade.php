                                    ...
                                    <div class="uk-grid uk-grid-small uk-child-width-1-2@s" data-uk-grid>
                                        ...
                                        <div>
                                            <input name="name" class="uk-input uk-form-large" type="text"
                                                placeholder="اسم المعدة *" value="{{ old('name') }}" required>
                                        </div>
                                        ...
                                        <div>
                                            <input name="location_address" class="uk-input uk-form-large" type="text"
                                                placeholder="الموقع *" value="{{ old('location_address') }}" required>
                                        </div>
                                        <div>
                                            <select name="position" class="uk-select uk-form-large" required>
                                        ...
                                        <div><input name="daily_rate" class="uk-input uk-form-large" type="number"
                                                step="0.01" placeholder="سعر الإيجار اليومي *"
                                                value="{{ old('daily_rate') }}"></div>
                                        <div><input name="weekly_rate" class="uk-input uk-form-large" type="number"
                                                step="0.01" placeholder="سعر الإيجار الأسبوعي *"
                                                value="{{ old('weekly_rate') }}"></div>
                                        <div><input name="monthly_rate" class="uk-input uk-form-large" type="number"
                                                step="0.01" placeholder="سعر الإيجار الشهري *"
                                                value="{{ old('monthly_rate') }}"></div>

                                        <div><input name="deposit_amount" class="uk-input uk-form-large" type="number"
                                                step="0.01" placeholder="قيمة الإيداع *"
                                                value="{{ old('deposit_amount') }}"></div>
